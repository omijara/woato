<?php $title = 'Home | Woato Foundation'; include("header.php"); ?>
...
<div id="myModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><a href="https://corona.gov.bd" target="_blank"><img class="aligncenter size-large wp-image-68015" src="https://a2i.gov.bd/wp-content/uploads/2020/03/Corona-Awarness-Card-10-05-2020-1024x1024.jpg" alt="" width="460" height="460"></a></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/support.jpg');" id="donate-section">
      <div class="container">
    ...
    <div class="site-section" id="blog-section">
      <div class="container">
        ...
        <div class="row">
         <div class="col-lg-6">
            <div>
              <a href="single.html" class="mb-4 d-block"><img src="images/support3.jpg" alt="Image" class="img-fluid rounded"></a>
              <h2><a href="single.html">Aware people around Kawran Bazar Area</a></h2>
          ...
          <div class="col-lg-6">
            <div>
              <a href="single.html" class="mb-4 d-block"><img src="images/support4.jpg" alt="Image" class="img-fluid rounded"></a>
              <h2><a href="single.html">Providing PPE in Mirpur-1</a></h2>
             <!-- <p class="text-muted mb-3 text-uppercase small"><span class="mr-2">January 18, 2019</span> By <a href="single.html" class="by">James Cooper</a></p> -->
