<?php $title = 'Events | Woato Foundation'; include("header.php"); ?>
...
<div class="site-section" id="blog-section">
      <div class="container">
        ...
        <div class="row">
         <div class="col-lg-6">
            <div>
              <a href="single.html" class="mb-4 d-block"><img src="images/aware (1).jpg" alt="Image" class="img-fluid rounded"></a>
          ...
          <div class="col-lg-6">
            <div>
              <a href="single.html" class="mb-4 d-block"><img src="images/aware (3).jpg" alt="Image" class="img-fluid rounded"></a>
              <h2><a href="single.html">Providing PPE in Mirpur</a></h2>
             <!-- <p class="text-muted mb-3 text-uppercase small"><span class="mr-2">January 18, 2019</span> By <a href="single.html" class="by">James Cooper</a></p> -->
