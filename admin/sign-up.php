                ...
                <div class="card-body p-5">
                  ...
                  <form action="signup-check.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                      ...
                      <div class="form-group col-md-12 mb-4">
                        <input type="email" class="form-control input-lg" name="email" aria-describedby="emailHelp" placeholder="E-mail" required="">
                      </div>
                      <div class="form-group col-md-12 mb-4 ">
                        ...
                        <input type="file" class="form-control input-lg"  name="img" required="">
                      </div>
