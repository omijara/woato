<?php $title = 'Profile | Tele Doctor'; include("header.php"); ?>
                  ...
                  <div class="col-lg-4 col-xl-3">
                    <div class="profile-content-left pt-5 pb-3 px-3 px-xl-5">
                      <div class="card text-center widget-profile px-0 border-0">
                        ...
                        <div class="card-body">
                          <h4 class="py-2 text-dark"><?php echo $_SESSION['fname']." ".$_SESSION['lname']; ?></h4>
                    ...
                    <div class="profile-content-right py-5">
                      ...
                      <div class="tab-content px-3 px-xl-5" id="myTabContent">
                        ...
                        <div class="card card-default" data-scroll-height="550" style="height: 550px; overflow: hidden;">
                          ...
                          </div><div class="slimScrollBar" style="background: rgb(153, 153, 153); width: 5px; position: absolute; top: 138px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 224.714px;"></div><div class="slimScrollRail" style="width: 5px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
                          <div class="mt-3"></div>
                        </div>
 </div>
                              <div class="col-xl-6"> 
                  <!-- To Do list -->
                  <div class="card card-default todo-table" id="todo" data-scroll-height="550" style="height: 550px; overflow: hidden;">
                    <div class="card-header justify-content-between">
                      <h2>To Do List</h2>
                    ...
                    </div><div class="slimScrollBar" style="background: rgb(153, 153, 153); width: 5px; position: absolute; top: 118px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 313.041px;"></div><div class="slimScrollRail" style="width: 5px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
                    <div class="mt-3"></div>
                  </div>
</div>
                              <div class="col-12">
                                ...
                                <div class="card card-table-border-none" id="recent-orders">
                                  <div class="card-header justify-content-between">
                                    ...
                                    <div class="date-range-report ">
                                      <span>May 22, 2020 - Jun 20, 2020</span>
                                    </div>
                                  </div>
